...
namespace Label_Package
{
    class cls_com
    {
        public static string g시스템명 = "Label_Package";
        public static string g상호 = "시스트데이타";
 ...
 //      public static string gConn_String = "Data Source=49.1.232.110,5000;Initial Catalog=hanwha_wis;User Id=syst5132;Password=tltmxm5132!@#";
        public static string gConn_String = "Data Source=49.1.232.110,5000;Initial Catalog=label_package ;User Id=syst5132;Password=tltmxm5132!@#";
        ...
        public static string g구분="",g관리사="",g아이디 = "", g암호 = "";
        public static int g필드수 = 15;
        public struct sDB
        {
        ...
        public struct s사용자
        {
            ...
            public static string 관리사 = "";
            public static string 거래처 = "";
            public static string 아이디 = "";
            public static string 암호 = "";
        ...
        public static void 로그(string d )
        {
            string ifile;

            d = String.Format("{0:yyyy.MM.dd}", DateTime.Now) + " " + String.Format("{0:HH:mm:ss}", DateTime.Now) + " " + d;
            디렉토리생성(cls_com.gLog_Path);
            ifile = cls_com.gLog_Path + "\\" + String.Format("{0:yyyy-MM-dd}", DateTime.Now).Substring(0,9) + ".txt";
            
            using (StreamWriter w = File.AppendText(ifile))
            {
                w.WriteLine(d);
            }

        }
        public static  void 디렉토리생성(string di)
        {
            try
            {
