    ...
    static class Program
    {
        ...
        static void Main()
        {
            ...
            else
            {
                ...
                cls_com.g관리사 = d[0].Trim();
                cls_com.g아이디 = d[1].Trim();
            }
        ...
        private static bool 로그인()
        {
            ...
            sql = "exec  S_a101_사용자_조회  '11','','" + cls_com.g관리사  +"','" + cls_com.g아이디 + "',''  ";
            ...
            {
                cls_com.s사용자.구분 = ds.Tables[0].Rows[0]["구분"].ToString();
                cls_com.s사용자.관리사 = ds.Tables[0].Rows[0]["관리사"].ToString();
                cls_com.s사용자.거래처 = ds.Tables[0].Rows[0]["거래처"].ToString();
